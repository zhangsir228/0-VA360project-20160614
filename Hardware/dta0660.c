...
const u8 eeprom_init[]={//V1.8版本DTA0660
...
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
0x0D,0x00,0x02,0x10,0x00,0x80,0x00,0x80,0x00,0x80,0x00,0x80,0x00,0x80,0x00,0x80,
...
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x5A,0xC6,0xCE,0x0F,0x0F,0x22,0x00,0x00
};															  														 //0xFD.1  该位置=1决定DTA0660蜂鸣器仅在通断测试时响 0x02
																															//0xFD.5    该位置=1决定DTA0660空载的时候0x20
uint8_t RxCounter = 0;
...
void DTA0660_Init(void)
{
	...
	delay_ms(1200);/*delay_ms(1000);*///2015-3-29：等待DTA将上电初始化数据发过来，以免造成后面数据接收混乱
}
