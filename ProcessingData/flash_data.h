...
//	float	Cap_value=0;
//	float	temp_value=0;
	float	Cal_VmV_zero[5];//DTA0660电阻相关校准参数
	float 	Cal_VmV_gain[5];//10 共70	

	float	Cal_ohm_zero[6];//DTA0660电阻相关校准参数
	float 	Cal_ohm_gain[6];//12 共82

	float	Cal_Cap_zero[4];//DTA0660电容相关校准参数
	float 	Cal_Cap_gain[4];//8 共90
