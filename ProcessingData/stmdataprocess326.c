...
/**************************************************************************************************************/
		...
		//窗口滤波电流平均值
		voltage_mean = Windows_Filter(voltage_mean,voltage_mean_tab,Window_num+20);
		current_mean = Windows_Filter(current_mean,current_mean_tab,Window_num+20);
...
//			active_power=active_power_sum / 5;//addcount;//平均后的 有功功率值
			...
			voltage_effective = Windows_Filter(voltage_temp,voltage_effective_tab,Window_num+10);
			current_effective = Windows_Filter(current_temp,current_effective_tab,Window_num+10);
